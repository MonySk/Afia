        ...
        builder: (context, child) => Stack(
          children: <Widget>[
            ClipPath(
              ...
              child: Container(
                decoration: BoxDecoration(
                  color: AppTheme.nearlyDarkGreen.withOpacity(0.5),
                  ...
                  gradient: LinearGradient(
                    colors: [
                      AppTheme.waterColorDarkBlue.withOpacity(0.2),
                      AppTheme.waterColorDarkBlue.withOpacity(0.5)
                    ],
            ...
            ClipPath(
              ...
              child: Container(
                decoration: BoxDecoration(
                  color: AppTheme.waterColorDarkBlue,
                  gradient: LinearGradient(
                    colors: [
                      AppTheme.waterColorDarkBlue.withOpacity(0.4),
                      AppTheme.waterColorDarkBlue
                    ],
                    begin: Alignment.topLeft,
                    end: Alignment.bottomRight,
                  ),
