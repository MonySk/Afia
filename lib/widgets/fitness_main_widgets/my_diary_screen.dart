...
import '../ui_view/title_view_no_arrow.dart';
...
class _MyDiaryScreenState extends State<MyDiaryScreen>
  ...
  void addAllListData() {
    ...
    listViews.add(
      TitleView(
        titleTxt: 'وجبات اليوم',
        textDirection: TextDirection.rtl,
        subTxt: 'معاينة كل الوجبات',
        animation: Tween<double>(begin: 0.0, end: 1.0).animate(CurvedAnimation(
            parent: widget.animationController!,
  ...
  Widget getAppBarUI() {
    return Column(
      // mainAxisAlignment: MainAxisAlignment.end, // Updated alignment
      children: <Widget>[
        AnimatedBuilder(
          animation: widget.animationController!,
          builder: (BuildContext context, Widget? child) {
            // * my variable to get user name
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Text(
                                    DateDisplay.formateDateToArabicNoYear(
                                        DateTime.now()),
                                    textAlign: TextAlign.right,
