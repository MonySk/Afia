...
class SmartFriendView extends StatelessWidget {
  final AnimationController animationController;

  const SmartFriendView({Key? key, required this.animationController})
      : super(key: key);
              ...
              SlideTransition(
                ...
                child: SlideTransition(
                  ...
                  child: const Padding(
                    ...
                    child: Text(
                      'اذا استصعب عليك اي من وظائف التطبيق لا تتردد في الذهاب الى نافذة المساعدة!',
