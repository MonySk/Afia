            ...
            children: [
              SlideTransition(
                ...
                child: Container(
                  ...
                  child: Image.asset(
                    'assets/introduction_animation/signup_image.png',
                    fit: BoxFit.contain,
                  ),
                ),
              ),
              SlideTransition(
                ...
                child: const Padding(
                  ...
                  child: Text(
                    "تبقت خطوات قليلة تفصلك على نمط حياة صحي",
                    textAlign: TextAlign.center,
                    style: TextStyle(fontSize: 25.0, fontWeight: FontWeight.bold, fontFamily: AppTheme.fontName),
                  ),
                ),
              ),
              const Padding(
                ...
                child: Text(
                  "قم بالتسجيل بالتطبيق لتتمكن من استخدام جميع المميزات الموجودة به",
                  textAlign: TextAlign.center,
